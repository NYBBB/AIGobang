...
class PolicyValueNet():
    def __init__(self, board_width, board_height, model_file=None):
        ...
        self.conv3 = tf.layers.conv2d(inputs=self.conv2, filters=128,
                                      ...
                                      data_format="channels_last",
                                      activation=tf.nn.relu)
        self.conv4 = tf.layers.conv2d(inputs=self.conv3, filters=192,
                                      kernel_size=[5, 5], padding="same",
                                      data_format="channels_last",
                                      activation=tf.nn.relu)
        
        # 3-1 Action Networks
        self.action_conv = tf.layers.conv2d(inputs=self.conv4, filters=4,
        ...
        self.evaluation_conv = tf.layers.conv2d(inputs=self.conv4, filters=2,
                                                kernel_size=[1, 1],
                                                padding="same",
                                                data_format="channels_last",
                                                activation=tf.nn.relu)
