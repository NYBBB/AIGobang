...
class person_fight:
    def __init__(self):
        ...
        for i in range(height):
            self.canvas.create_line(32, (int(35 * 15 // height) * i + 38), 35 * (height - 8) * 2 + 33, (int(35 * 15 // height) * i + 38))
            self.canvas.create_line((int(35 * 15 // height) * i + 32), 38, (int(35 * 15 // height) * i + 32), 35 * (height - 8) * 2 + 37)
        # 点
        point_x = [3, 7, 3, 11, 11]
        point_y = [3, 7, 11, 11, 3]
        for i in range(5):
